...
public class WindowShape
{
    ...
    public double area()
    {
        double rec_area, semic_area;
        rec_area = getHeight() * getWidth();
        semic_area = Math.PI * Math.pow((getWidth() / 2), 2) / 2;
        return rec_area + semic_area;
    }
    ...
    public static double area(double x, double y)
    {
        double rec_area, semic_area;
        rec_area = x * y;
        semic_area = Math.PI * Math.pow((x / 2), 2) / 2;
        return rec_area + semic_area;
    }
}
