...
public class MyAgent extends Agent
{
    ...
    {
        int winningColumn = nextWinningColumn('R');
    ...
    {
        int opponentWinningColumn = nextWinningColumn('Y');
        return opponentWinningColumn;
    }

    /**
     * Returns the column that will win the game in the next go.
     *
     *
     * @return the next winning column.
     */
    public int nextWinningColumn(char colour)
    {
        int nextWinningColumn = -1;
        nextWinningColumn = myGame.threeInARow(colour);
